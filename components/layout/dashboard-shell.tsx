...
export function DashboardShell({
  ...
  return (
    <div className="min-h-screen">
      ...
      <main
        className={cn(
          "min-h-screen pb-16 transition-[margin] duration-300 ease-out motion-reduce:transition-none md:ml-54.5",
          agentOpen ? "lg:mr-105" : "lg:mr-0"
        )}
      >
        <TopBar />
        <div className="mx-auto max-w-310 px-4 pb-10 pt-6 sm:px-7 lg:px-8 lg:pt-8">
          {children}
        </div>
      </main>

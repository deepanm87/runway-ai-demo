...
export function OverviewPage() {
  ...
  return (
    <div id="overview-page" data-avatar-target="overview-page">
      <PageHeader 
        eyebrow="Live operations · Toronto"
        title="Your support signal."
        description="Open any card yourself, or ask Deep to navigate and take the same actions."
      />
      ...
      <Card
        ...
        className="mt-5 overview-hidden"
      >
        ...
        <div className="divide-y divide-(--line)">
          {recentTickets.map(ticket => (
            <button
              ...
              className="flex w-full items-center gap-4 px-5 py-4 text-left transition hover:bg-(--surface-raised) sm:px-6"
              onClick={() => 
                openPanel({
